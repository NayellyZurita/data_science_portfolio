...
In our Tech Lab, I worked on building and optimizing a real-time monitoring pipeline for student virtual machines. The system collected streaming metrics (CPU, memory, network, process, and swap usage) using Kafka, stored them in TimescaleDB (PostgreSQL), and visualized insights in Grafana—all hosted on an AWS EC2 instance.
